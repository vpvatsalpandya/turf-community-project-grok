...
import { Check, ChevronLeft, Copy, MapPin } from "lucide-react";
    ...
    <main className="mx-auto min-h-dvh max-w-lg bg-bg pb-28">
      <header className="sticky top-0 z-10 border-b border-border bg-bg/90 px-4 py-3 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          <Link to="/" className="grid size-11 place-items-center rounded-md hover:bg-raised">
          ...
          <div className="min-w-0">
            ...
            {venue ? (
              <p className="flex items-center gap-1 text-xs text-muted">
                ...
                {venue.city} · {inr(venue.priceInr)}/hr
              </p>
            ) : null}
          </div>
        </div>
